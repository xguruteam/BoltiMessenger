...
//                                       "MIIBCgKCAQEArjxlUHYo1N998bS36kyddD92Nu/RlM/WMgmH+nFJvg/J838cF7AG\n"
//                                       "hAn2G279vuqIjCMTDD+IECgoy9yWLIvPtruHkBBnkeWpJCtLez0wWYbZK/A0/qao\n"
//                                       "UqZsq9STm7jZ/+jhGpyBEIQrz8NWqttOC09OyMQtA6TZC+Tj927yr8nc7JjB/gBK\n"
//                                       "ELeDdjU4++huLHi+lLuVQjEeEdLtCRSfPF5RSB4Nk6C2HaOEVFGm1eaXH0NE5psQ\n"
//                                       "XJpbBI3uWWSSREMpfciKZGuG+MHot/lWeISg2ZZ4tKEnvB+sskTiTjET0ns0DxJy\n"
//                                       "w/9fJ80kUIjIcqQsS0Zzds22iMjMOh2XEQIDAQAB\n"
//                                       "-----END RSA PUBLIC KEY-----");
//            serverPublicKeysFingerprints.push_back(0xf7143062cd0c9489LL);
...
//            }
            ...
            TLObject *innerData;
            DEBUG_D("handshakeType: ", handshakeType);
            if (handshakeType == HandshakeTypePerm) {
                DEBUG_D("TL_p_q_inner_data_dc !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
                ...
                DEBUG_D("TL_p_q_inner_data_temp_dc !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
            ...
            uint8_t *data= innerDataBuffer->bytes() + SHA_DIGEST_LENGTH;
            size_t final_len = innerDataSize * 2;
            unsigned char* chrs = (unsigned char *) malloc((final_len + 1) * sizeof(*chrs));
            unsigned int j = 0;
            for(j = 0; j<innerDataSize; j++) {

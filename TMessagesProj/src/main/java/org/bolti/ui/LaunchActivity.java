...
import org.bolti.messenger.camera.CameraController;
...
import org.bolti.ui.Adapters.DrawerLayoutAdapter;
import org.bolti.ui.ActionBar.ActionBarLayout;
import org.bolti.ui.ActionBar.BaseFragment;
import org.bolti.ui.ActionBar.DrawerLayoutContainer;
import org.bolti.ui.Cells.DrawerAddCell;
import org.bolti.ui.Cells.DrawerUserCell;
import org.bolti.ui.Cells.LanguageCell;
import org.bolti.ui.Components.AudioPlayerAlert;
import org.bolti.ui.Components.AlertsCreator;
import org.bolti.ui.Components.BlockingUpdateView;
        ...
        if (!fromPassword && (AndroidUtilities.needShowPasscode(true) || SharedConfig.isWaitingForPasscodeEnter)) {
            ...
            if (UserConfig.getInstance(currentAccount).isClientActivated() && (flags & Intent.FLAG_ACTIVITY_LAUNCHED_FROM_HISTORY) == 0) {
                if (intent != null && intent.getAction() != null && !restore) {
                    ...
                    } else if (intent.getAction().equals("org.bolti.messenger.OPEN_ACCOUNT")) {
                        open_settings = 1;

...
public class PhotoAttachPhotoCell extends FrameLayout {
    public final static int CELL_SIZE = 120;
    ...
    public PhotoAttachPhotoCell(Context context) {
        ...
        addView(imageView, LayoutHelper.createFrame(CELL_SIZE, CELL_SIZE));
        checkFrame = new FrameLayout(context);
        addView(checkFrame, LayoutHelper.createFrame(42, 42, Gravity.RIGHT | Gravity.TOP, 38, 0, 0, 0));
        ...
        addView(videoInfoContainer, LayoutHelper.createFrame(CELL_SIZE, 16, Gravity.BOTTOM | Gravity.LEFT));
        ...
        checkBox.setColor(0xff22b83e, 0xffffffff);
        addView(checkBox, LayoutHelper.createFrame(30, 30, Gravity.RIGHT | Gravity.TOP, 46, 4, 10, 0));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        if (isVertical) {
            super.onMeasure(MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(CELL_SIZE), MeasureSpec.EXACTLY), MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(CELL_SIZE + (isLast ? 0 : 6)), MeasureSpec.EXACTLY));
        } else {
            super.onMeasure(MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(CELL_SIZE + (isLast ? 0 : 6)), MeasureSpec.EXACTLY), MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(CELL_SIZE), MeasureSpec.EXACTLY));
        }
    }
